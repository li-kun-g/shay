...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "isGroupAccount" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "EventRequest" ADD CONSTRAINT "EventRequest_requestedById_fkey" FOREIGN KEY ("requestedById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
