...
const DICTS: Record<Lang, Record<I18nKey, string>> = {
  EN: {
    ...
    "settings.language.subtitle": "Choose the language for Shay.",
    ...
    "composer.placeholder": "What’s the tea today? ☕",
...
"messages.supportHint": "Contact Shay administration for reports, suggestions, and complaints.",
...
"settings.support.desc": "Open your support chat with Shay for reports, suggestions, and complaints.",
"settings.theme.title": "Theme",
"settings.theme.pageDesc": "Customize the look of Shay.",
...
"settings.support.pageDesc.after": "permanent chat with the Shay administration.",
...
"friends.you": "You",
"groups.title": "Groups",
"groups.subtitle": "Only official organizations are shown right now.",
...
"common.done": "Done",
  ...
  RU: {
    ...
    "settings.language.subtitle": "Выберите язык интерфейса Shay.",
    ...
    "composer.placeholder": "Что нового сегодня? ☕",
...
"messages.supportHint": "Свяжитесь с администрацией Shay для жалоб, предложений и обращений.",
...
"settings.support.desc": "Откройте чат поддержки Shay для жалоб, предложений и обращений.",
"settings.theme.title": "Тема",
"settings.theme.pageDesc": "Настройте свой вайб с Shay.",
...
"settings.support.pageDesc.after": "постоянный чат с администрацией Shay.",
...
"friends.you": "Вы",
"groups.title": "Группы",
"groups.subtitle": "Сейчас показываются только официальные организации.",
...
"common.done": "Готово",
  ...
  KK: {
    ...
    "settings.language.subtitle": "Shay интерфейсінің тілін таңдаңыз.",
...
"messages.supportHint": "Шағымдар, ұсыныстар және өтініштер үшін Shay әкімшілігіне жазыңыз.",
...
"settings.support.desc": "Шағымдар, ұсыныстар және өтініштер үшін Shay билігімен қолдау чатын ашыңыз.",
"settings.theme.title": "Тақырып",
"settings.theme.pageDesc": "Shay көрінісін баптаңыз.",
...
"settings.support.pageDesc.before": "Қателер туралы хабарлаңыз, ұсыныс жіберіңіз. Сізде Shay әкімшілігімен",
...
"friends.you": "Сіз",
"groups.title": "Топтар",
"groups.subtitle": "Қазір тек ресми ұйымдар көрсетіледі.",
